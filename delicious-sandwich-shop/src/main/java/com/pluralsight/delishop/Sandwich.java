...
public class Sandwich extends Items {
    ...
    public Sandwich(BreadLength breadLength, BreadType breadType, com.pluralsight.delishop.Cheese cheeses, Meat bigMeats, List<Topping> toppingList, SauceFlavor sauceFlavor, SideType sideType, boolean toastedSandwich) {
